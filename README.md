...
Projeto apresentado no **Capítulo 13** do livro, mais precisamente o capítulo "Leitura de Códigos com Barcode Scanner".

<img src="https://www.thiengo.com.br/img/livro/desenvolvedor-kotlin-android-bibliotecas-para-o-dia-a-dia/github/aplicativo-android-capitulo-13.jpg" alt="Telas do aplicativo Android do capítulo 13" height="360">

**Observação importante:** para o total entendimento do projeto é preciso ter em mãos o livro "Desenvolvedor Kotlin Android" com o capítulo 13 já aberto, pois as explicações detalhadas de todo o projeto deste repositório estarão nesta parte do livro.
